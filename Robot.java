...
public class Robot extends TimedRobot {
  ...
  private PWMVictorSPX Hang = new PWMVictorSPX(6);
  private VictorSP Slider = new VictorSP(0); 
  ...
  private PWMVictorSPX Fold = new PWMVictorSPX(5);
  ...
  private Joystick Arduino = new Joystick(3);
  ...
  if (joystick3.getRawButton(10)){
    Slider.set(1);
  }else if (joystick3.getRawButton(11)){
    Slider.set(-1);
  } else {
    Slider.set(0);
  }
  ...
  //Lifter Set Position Activate
    ...
    */
    ...
    }else if (Arduino.getRawButton(2) == true){
    ...
    if (joystick.getRawButton(2) == true)  {
      ...
      OutTake.set(0.6);
      InTake.set(0.0);
    } else if (Arduino.getRawButton(1) == true){
      OutTake.set(-0.6);
      InTake.set(0.7);
    }else {
      InTake.set(0.0);
